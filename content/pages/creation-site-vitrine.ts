import type { Localized, ServiceLandingContent } from "./types";

export const creationSiteVitrineContent: Localized<ServiceLandingContent> = {
  fr: {
    serviceName: "Création de site vitrine professionnel",
    serviceType: "Website design and development",
    eyebrow: "Création site vitrine",
    titleLines: ["Un site vitrine", "qui donne envie."],
    intro:
      "WebCode Studio crée des sites vitrines professionnels pour présenter votre activité, valoriser votre expertise et générer des contacts qualifiés. Chaque page est pensée pour être claire, rapide, crédible et optimisée pour Google.",
  ...
  en: {
    ...
    titleLines: ["A showcase website", "people want to contact."],
    intro:
      "WebCode Studio creates professional showcase websites to present your activity, highlight your expertise and generate qualified contacts. Every page is designed to be clear, fast, credible and optimized for Google.",
