...
export const dictionary = {
  fr: {
    ...
    footer: {
      ...
      searches: "Recherches",
      contact: "Contact",
      webCreation: "Création de site internet",
      mobileApps: "Applications & outils métier",
      uiUx: "Design UI/UX",
      projects: "Nos Projets",
      localWebCreation: "Création site internet Montbéliard",
  ...
  en: {
    ...
    footer: {
      ...
      mobileApps: "Business apps & tools",
      uiUx: "UI/UX Design",
